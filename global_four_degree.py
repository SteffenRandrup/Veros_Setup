...
DATA_FILES = veros.tools.get_assets("global_4deg", os.path.join(BASE_PATH, "assets_4deg.yml"))
...
class GlobalFourDegree(veros.Veros):
    ...
    def set_parameter(self):
        ...
        # self.runlen = 10 * 360 * self.dt_tracer
        # self.trcmin = 1e-13
        self.trcmin = 0
    ...
    def set_initial_conditions(self):
        ...
        if self.enable_npzd:
            ...
            # self.detritus[...] = 1 * self.maskT[..., np.newaxis]
    ...
    def set_diagnostics(self):
        ...
        self.diagnostics["averages"].sampling_frequency = self.runlen // 800

        # self.diagnostics["overturning"].output_frequency = self.runlen // 200
        # self.diagnostics["overturning"].sampling_frequency = self.runlen // 800
